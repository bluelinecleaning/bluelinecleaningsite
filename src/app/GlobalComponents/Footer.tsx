  ...
  return (
    <footer className='bg-gradient-to-b from-gray-100 to-gray-300'>
      <div className="page fira text-blueBranding flex flex-col gap-[0.5rem] md:gap-[1rem] ">
        <Image 
          src={Logo}
          className='w-[7rem] md:w-[10rem] mx-auto'
          title='Blueline Logo'
          alt='Blueline Logo'
        />
        ...
        <p className='font-bold text-center text-[0.875rem] md:text-[1.2rem]'>Connect with us</p>
        <div className="flex items-center justify-center gap-1 md:gap-2">
          <Link href={'https://www.facebook.com/bluelinelaundry/'} target='_blank'><svg className="h-8 md:w-10 w-8 md:h-10 bg-blueBranding text-white rounded-full p-1"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg></Link>
