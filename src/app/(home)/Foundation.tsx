...
const Foundation = () => {
  ...
  <article className='bg-gray-100 fira py-[2rem]'>
    ...
    <div className='page'>
        ...
        <div className='pt-[2rem] text-[0.875rem] sm:text-[1rem] flex flex-col gap-[0.5rem]'>
    ...
    <div className="px-[1rem] flex w-full items-center gap-[1rem]">
        ...
        <div className="sticky top-0 flex flex-col gap-[3rem] h-screen w-3/5 justify-center sm:items-end ">
            <div className="absolute opacity-20 top-[4rem] -ml-[5rem] sm:ml-0 animate-bounce w-full flex justify-center bg-blueBranding rounded-xl ">
                <Image 
                    src={Logo}
    ...
    <div className='-mt-[8rem] page flex gap-2 justify-center'>
        <Image 
            src={Charity}
