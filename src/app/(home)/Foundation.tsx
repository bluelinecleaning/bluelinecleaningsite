...
const Foundation = () => {
  ...
  <article className='bg-gray-100 fira py-[2rem]'>
    ...
    <div className='page'>
        <h3 className='font-bold text-[1.875rem] md:text-[2.3rem] leading-[2rem] text-center'>WHO WE ARE</h3>
        <div className='pt-[2rem] md:pt-[3rem] text-[0.875rem] sm:text-[1rem] md:text-[1.175rem] flex flex-col gap-[0.5rem]'>
    ...
    <h3 className='mt-[2rem] font-bold text-[1.875rem] md:text-[2.3rem] leading-[2rem] text-center'>OUR VALUES</h3>
    <div className="px-[1rem] flex w-full items-center gap-[1rem]">
        ...
        <div className="sticky top-0 flex flex-col gap-[3rem] h-[66.6667vh] w-3/5 justify-center sm:items-end ">
            <aside className=' relative aspect-square w-full sm:w-[16rem] rounded-2xl bg-gray-300 shadow-md shadow-gray-600'>
    ...
    <div className='-mt-[3rem] sm:-mt-[5rem] page flex gap-2 justify-center'>
        <Image 
            src={Charity}
