    ...
    <section className=' bg-gradient-to-b from-[#0181AC] to-gray-300 border-b border-blueBranding' id='impact'>
      <div className='page 2xl:w-3/4 2xl:mx-auto flex flex-col gap-[1rem] md:gap-[3rem] lg:gap-[6rem]'>
        ...
        <div className="flex flex-col gap-2 text-white narrative text-justify">
          <p className=''>Quality and safety are central to every aspect of our operations. Blueline is ISO9001 and ISO14001 accredited, ensuring our services meet the highest benchmarks for quality and environmental management. We maintain rigorous quality control measures and comprehensive safeguarding policies to protect both our customers and employees.</p>
